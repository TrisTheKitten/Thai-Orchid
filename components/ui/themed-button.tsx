...
const buttonVariants = cva(
  'inline-flex items-center justify-center whitespace-nowrap rounded-xl text-sm font-medium ring-offset-background transition-all duration-300 ease-out focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 group',
  {
    variants: {
      variant: {
        default:
          'glass-blur text-slate-800 shadow-lg border border-white/40 hover:bg-white/50 hover:shadow-xl motion-safe:hover:scale-[1.02] motion-safe:active:scale-[0.98] active:bg-white/40',
        destructive:
        ...
        secondary:
          'border border-warmOrange-200/50 bg-white/70 text-charcoal-800 backdrop-blur-md shadow-glass-sm hover:bg-warmOrange-50/80 hover:text-charcoal-900',
        ghost:
          'text-charcoal-800 hover:bg-warmOrange-100/60 hover:text-warmOrange-800 backdrop-blur-sm',
        link: 'text-warmOrange-700 underline-offset-4 hover:text-warmOrange-800 hover:underline',
        accent:
          'bg-gradient-to-r from-warmOrange-500 to-deepAmber-600 text-white shadow-glass-sm border border-warmOrange-500/30 hover:from-warmOrange-600 hover:to-deepAmber-700 hover:shadow-glass-md focus-visible:ring-warmOrange-400 motion-safe:hover:scale-[1.02] motion-safe:active:scale-[0.98]',
      },
      size: {
